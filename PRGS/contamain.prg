...
SET PATH TO "DATA;FORMS;ICO;LIB1.0;MPR;PRGS;REPORTS;UTILITIES"
...
**7 JUL 2015 CONTA 3 YA NO ES NECESARIO 
*DO CHANGECRITICOS 
DO configapp 
...
**01/11/2015 conta class added to _screen 
IF VARTYPE(_screen.conta1)="U"
	_screen.NewObject("conta1","conta","lib1.0\_conta.vcx")	
ENDIF 
